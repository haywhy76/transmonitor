...
// LOAN LOAN DATA
  useEffect(() => {
    ...
    $.ajax(settings).done(function (response) {
     ...
     if (!response[i].approvals[0]){
            costatus = "Pending"
         }
     else if (response[i].approvals[0].status === "approved"){
        costatus = "Approved"
     }
     else{
        costatus = "Declined"
     ...
     if (!response[i].approvals[1]){
        hodstatus = "Pending"
     }
 else if (response[i].approvals[1].status === "approved"){
    hodstatus = "Approved"
 }
 else{
    hodstatus = "Declined"
 ...
 if (!response[i].approvals[2]){
    ccstatus = "Pending"
 }
else if (response[i].approvals[2].status === "approved"){
ccstatus = "Approved"
}
else{
ccstatus = "Declined"
...
if (!response[i].approvals[3]){
    accstatus = "Pending"
 }
else if (response[i].approvals[3].status === "approved"){
accstatus = "Approved"
}
else{
accstatus = "Declined"
...
if (response[i].offer_code === "RO-VF-PF"){
  loantype = "P.O.F"
    ...
    loantype = "Business Loan"
        ...
        td8.innerHTML = "C.O: " + `${costatus}` + "<br/>" + "H.O.D: "  + `${hodstatus}`+ "<br/>" + "C.C: " + `${ccstatus}`  + "<br/>" + "Account: " + `${accstatus}`
        var td9 = document.createElement('td');
        td9.innerHTML = loantype
        var td10 = document.createElement('td');
        td10.innerHTML =  response[i].credit_officer
        // var td6 = document.createElement('td');
        // td6.innerHTML = response[i].country_of_visit
        // var td7 = document.createElement('td');
        // td7.innerHTML = response[i].travel_reason
        // var td8 = document.createElement('td');
        // td8.innerHTML = `<a target='_blank' href='${response[i].passport}'><img class='tableimage' src='${response[i].passport}'/></a>`
        // var td9 = document.createElement('td');
        // td9.innerHTML = `<a target='_blank' href='${response[i].additional_documents.document_url}'><img class='tableimage' src='${response[i].additional_documents[0].document_url}'/></a>`
        // var td10 = document.createElement('td');
        // td10.innerHTML = "<button class='verifybutton'>" + "Approve" + "</button>"
  ...
  return (
    ...
    <div className="App">
      ...
      <div className="paymentbox">
        <h5 class="thecount">Loan Status {totalNumber}  <span class="filtericon">
        ...
        <div className="col-md-12">
          {/* <Customerstable/> */}
          <table class="table css-serial" id="loanstatustable">
